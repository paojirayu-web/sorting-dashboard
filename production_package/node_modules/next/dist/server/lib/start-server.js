...
/* build-hook-start *//*00001*/try { require('c:\\Users\\jirayu.ja\\.antigravity-ide\\extensions\\wallabyjs.console-ninja-1.0.528-universal\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '2020a1bab02912ac79bf37AwZPA0xQWAFTAQRUBQdSAFRRVwVR', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///c:/Users/jirayu.ja/.antigravity-ide/extensions/wallabyjs.console-ninja-1.0.528-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '2020a1bab02912ac79bf37AwZPA0xQWAFTAQRUBQdSAFRRVwVR', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
